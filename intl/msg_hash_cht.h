...
MSG_HASH(
   ...
   "Miyoo的即時CPU電源控制，從200Mhz到1600Mhz。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "為目前 ROM 儲存選定的 cpu 功率，如果先前已定義，則這優先於核心速度。"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_NETPLAY_HOST,
   "在支援的核心上作為播放器 1 啟動網路功能。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "返回通用的 Retroarch 快捷選單並停用自訂 Miyoo 選單，以進行更深入的設定。"
   )
MSG_HASH(
