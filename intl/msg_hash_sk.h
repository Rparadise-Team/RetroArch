...
MSG_HASH(
   ...
   "Vyberte slot, ktorý chcete uložiť."
   )
MSG_HASH(
   MENU_ENUM_LABEL_MIYOO_LOAD_STATE,
   "Vyberte slot, ktorý chcete načítať."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Nastaviť rýchlosť taktu CPU Miyoo"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_MIYOO_SAVE_CPU_CLOCK_CORE,
   "Uložiť takt CPU (jadro)"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Spustiť Netplay (server)"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_MIYOO_NETPLAY_CLIENT,
   "Hostiteľ/LAN Netplay (klient)"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Riadenie výkonu CPU pre Miyoo v reálnom čase, od 200 MHz do 1600 MHz."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Zobraziť úspechy s náhľadmi odznakov v tomto menu."
   )
MSG_HASH(
