...
MSG_HASH(
   ...
   "Miyoo的实时CPU电源控制，从200Mhz到1600Mhz。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "为当前 ROM 保存选定的 cpu 功率，如果之前已定义，则这优先于核心速度。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "返回通用的 Retroarch 快捷菜单并禁用自定义 Miyoo 菜单，以进行更深入的设置。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "返回自定义菜单Miyoo，禁用通用retroarch快捷菜单。"
   )
#endif
