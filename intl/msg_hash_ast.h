...
MSG_HASH( /* FIXME Is a specific image format used? Is it determined automatically? User choice? */
   ...
   "Volquia un discu físicu al almacenamientu internu ya guárdalu como un ficheru d'imaxe."
   )
#ifdef HAVE_LAKKA
MSG_HASH(
...
MSG_HASH(
   ...
   "Sustitúi tolos nucleos heredaos ya instalaos manualmente poles últimes versiones de la Play Store si tán disponibles."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Baxa'l paquete de miniatures completu del sistema seleicionáu."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Baxa les miniatures de les entraes que tán na llista seleicionada."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Baxa conteníu gratuitu pal nucleu seleicionáu."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Compatibilidá colos puntos de guardáu"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Seleccione la ranura para guardar."
   )
MSG_HASH(
   MENU_ENUM_LABEL_MIYOO_LOAD_STATE,
   "Seleccione la ranura para cargar."
   )
MSG_HASH(
   MENU_ENUM_LABEL_MIYOO_CPU_CLOCK,
   "Seleccione MHz para CPU MIYOO."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Afitar la velocidá del relóx de CPU de Miyoo"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_MIYOO_SAVE_CPU_CLOCK_CORE,
   "Guardar relóx de CPU (núcleu)"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Servidor/LAN de xuegu en rede (veceru)"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "cierra menu, vuelve al juego"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_SAVE_STATE,
   "Crea captura de guardado de la rom."
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_LOAD_STATE,
   "Carga captura de guardado de la rom."
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_SYNC_NOW,
   "Sincroniza archivos de guardado en la nube."
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_CPU_CLOCK,
   "Control de la potencia de la cpu en tiempo real para Miyoo, desde 200Mhz a 1600Mhz."
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_SAVE_CPU_CLOCK_CORE,
   "guarda la potencia de cpu seleccionado para el core actual."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Arranca funciones de red como jugador 1 en cores compatibles."
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_NETPLAY_CLIENT,
   "Menu de configuracion de Net-play y listado de salas disponibles."
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_MIYOO_RETROARCH_SETTINGS,
   "vuelve al quick menu generico de retroarch y deshabilita Custom Miyoo Menu, para configuraciones mas profundas."
   )
MSG_HASH(
