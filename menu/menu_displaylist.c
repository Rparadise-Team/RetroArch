      ...
      )
{
...
#ifdef IOS
   {
      ...
      if (str_list->size <= 0)
      {
cloud         char dir[PATH_MAX_LENGTH];
      ...
      case DISPLAYLIST_CLOUD_SYNC_SETTINGS_LIST:
         {
            menu_displaylist_build_info_t build_list[] = {
               ...
               {MENU_ENUM_LABEL_CLOUD_SYNC_SYNC_THUMBS,  PARSE_ONLY_BOOL           },
               {MENU_ENUM_LABEL_CLOUD_SYNC_SYNC_SYSTEM,  PARSE_ONLY_BOOL           },
      ...
      case DISPLAYLIST_MENU_SETTINGS_LIST:
         {
            ...
            menu_displaylist_build_info_selective_t build_list[] = {
               ...
               {MENU_ENUM_LABEL_MENU_RGUI_FULLSCREEN_STRETCH,                 PARSE_ONLY_BOOL,   true},
