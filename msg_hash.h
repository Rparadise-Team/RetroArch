...
enum msg_file_type
{
   ...
   FILE_TYPE_MIYOO_MENU,
   FILE_TYPE_MIYOO_RESUME,
   FILE_TYPE_MIYOO_SAVE_STATE,
   FILE_TYPE_MIYOO_LOAD_STATE,
   FILE_TYPE_MIYOO_SYNC_NOW,
   FILE_TYPE_MIYOO_CPU_CLOCK,
   FILE_TYPE_MIYOO_SAVE_CPU_CORE,
   FILE_TYPE_MIYOO_SAVE_CPU_ROM,
   FILE_TYPE_MIYOO_ACHIEVEMENTS,
   FILE_TYPE_MIYOO_NETPLAY_HOST,
   FILE_TYPE_MIYOO_NETPLAY_CLIENT,
   ...
   FILE_TYPE_MIYOO_CPU_BACK,
   FILE_TYPE_MIYOO_QUICK_MENU,
   FILE_TYPE_MIYOO_QUIT_RETROARCH,
...
enum msg_hash_enums
{
   ...
   MENU_LABEL(MENU_RGUI_FULLSCREEN_STRETCH),
